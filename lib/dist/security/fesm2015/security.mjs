...
class MainService {
    ...
    getRetuenUrlWithAcctID(acct, returnUrl) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getAllAssignedComponents(acct_id) {
        return __awaiter(this, void 0, void 0, function* () {
            const resp = yield this.http
    ...
    verifyMsg(otp_entered_by_user, session_id) {
        return __awaiter(this, void 0, void 0, function* () {
            var str = 'https://2factor.in/API/V1/' +
                this.api_key +
                '/SMS/VERIFY/' +
...
class LoginComponent {
    ...
    ngAfterContentInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                yield this.IPAddressofUser();
            }), 500);
            //browser set
            this.browser = yield this.UserBrowserName();
            ...
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                yield this.audit_insert(this.audit_info_obj);
            }), 3000);
        });
    }
    ...
    getCurrentLegalEntity() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var resp = yield this.mainService.getCurrentLegalEntity(JSON.stringify(party_details));
            if (resp['error'] == false) {
    ...
    SubmitAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getAccountModule(this.b_acct_id);
            this.login = this.selectedaccount;
            yield this.getUserRoleInfo();
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isChecked == 0 || this.isChecked == 1) {
                ...
                if (mobile_valid == true && this.isChecked == 0) {
                    ...
                    var resp = yield this.mainService.loginERP(userloginmob);
                    if (resp['error'] == false && resp['data'].length > 0) {
                        if (this.urlPassAcctID == undefined || null || '') {
                            ...
                            if (resp['data'].length > 1) {
                                yield this.selectMultiAccount();
                            }
                            else {
                                yield this.selectOneAccount();
                            }
                        }
                        else {
                ...
                //check email login
                    ...
                    var resp = yield this.mainService.loginERP(userloginemail);
                    if (resp['error'] == false && resp['data'].length > 0) {
                        if (this.urlPassAcctID == undefined || null || '') {
                            if (this.currentOrigin != this.solnHostUrl) {
                                resp['data']
    ...
    // Account moduleinfo
    getAccountModule(b_acct_id) {
        return __awaiter(this, void 0, void 0, function* () {
            var account = { b_acct_id: b_acct_id };
            var resp = yield this.mainService.getaccountmodule(JSON.stringify(account));
            if (resp['error'] == false) {
    ...
    getUserRoleInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (empid.b_acct_id == 0) {
                resp = yield this.mainService.getCurrentUserFromAdmin(JSON.stringify(empid));
            }
            else {
                resp = yield this.mainService.getCurrentUserFromMD(JSON.stringify(empid));
            }
            if (resp['error'] == false) {
    ...
    audit_insert(audit_info_obj) {
        return __awaiter(this, void 0, void 0, function* () {
            var resp = yield this.mainService.createloginInfo(audit_info_obj);
        });
    }
    //final submit
    finalSubmit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let partyDetail = yield this.getSetPartyName();
            ...
            this.login['assigned_component'] = yield this.getAllAssignedComponent(this.b_acct_id, this.assigned_User_Roles);
            ...
            /// jwt token generated
            const _a = this.login, { ident_verify_secret } = _a, filterdata = __rest(_a, ["ident_verify_secret"]);
            var resp = yield this.mainService.generateTokens(filterdata);
    ...
    getAllAssignedComponent(b_acct_id, role_cd) {
        return __awaiter(this, void 0, void 0, function* () {
            var assign = { b_acct_id: b_acct_id, role_cd: role_cd };
            if (this.b_acct_id == 0) {
                var resp = yield this.mainService.getresourcebyrolecd(JSON.stringify(assign));
            }
            else {
                var resp = yield this.mainService.getAllAssignedComponents(JSON.stringify(assign));
            }
    ...
    getSetPartyName() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var resp = yield this.mainService.getCurrentLegalEntity(JSON.stringify(partydel));
            if (resp['error'] == false) {
                return resp['data'][0];
            }
            else {
    ...
    sendOtp() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var resp = yield this.mainService.loginERP(otpuserobj);
            if (resp['error'] == false) {
                if (resp['data'].length == 0) {
            ...
            var resp = yield this.mainService.sendMsg(this.legal_mobile_no);
    ...
    LoginWithOtp() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.otpuser['mobile_number'] == this.legal_mobile_no) {
                ...
                this.audit_info_obj['password'] = null;
                //verfiy otp
                if (yield this.mainService.verifyMsg(this.otpuser['otp_no'], this.session_id)) {
                    ...
                    var resp = yield this.mainService.loginERP(otpuserdata);
                    if (resp['error'] == false && resp['data'].length > 0) {
                        if (this.urlPassAcctID == undefined || null || '') {
                            if (this.currentOrigin != this.solnHostUrl) {
                                resp['data']
    ...
    isAuthenticated() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.param_jwt == undefined || this.param_jwt == null) {
                ...
                var resp = yield this.mainSVC.verfiyTokens(obj);
                if (resp['error'] == false) {
